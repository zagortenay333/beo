...
fenum (AstFlags, U64) {
    ...
    AST_CAN_EVAL            = flag(1),
    AST_CAN_EVAL_WITHOUT_VM = flag(2),
    AST_CHECKED             = flag(3),
    AST_CREATES_SCOPE       = flag(4),
    AST_CREATES_TYPE        = flag(5),
    AST_EVALED              = flag(6),
    AST_IS_CAN_EVAL         = flag(7),
    AST_IS_FN_ARG           = flag(8),
    AST_IS_GLOBAL_VAR       = flag(9),
    AST_IS_LITERAL          = flag(10),
    AST_IS_LOCAL_VAR        = flag(11),
    AST_IS_LVALUE           = flag(12),
    AST_IS_READ_ONLY        = flag(13),
    AST_IS_SEALED_SCOPE     = flag(14),
    AST_IS_TYPE             = flag(15),
    AST_MUST_EVAL           = flag(16),
    AST_VISITED             = flag(17),
