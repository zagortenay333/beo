...
fenum (AstFlags, U64) {
    ...
    AST_EVALED              = flag(5),
    AST_IS_CAN_EVAL         = flag(6),
    AST_IS_FN_ARG           = flag(7),
    AST_IS_GLOBAL_VAR       = flag(8),
    AST_IS_LITERAL          = flag(9),
    AST_IS_LOCAL_VAR        = flag(10),
    AST_IS_LVALUE           = flag(11),
    AST_IS_READ_ONLY        = flag(12),
    AST_IS_SEALED_SCOPE     = flag(13),
    AST_IS_TYPE             = flag(14),
    AST_MUST_EVAL           = flag(15),
    AST_VISITED             = flag(16),
